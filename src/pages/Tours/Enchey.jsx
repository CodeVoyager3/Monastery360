        ...
        <>
            ...
            <div className="animated-gradient-bg -mt-20 min-h-screen text-gray-800 font-serif overflow-x-hidden">
                <div className="container mx-auto px-4 sm:px-6 pt-28 pb-16">
                    ...
                    <main>
                        {/* --- Hero Section --- */}
                        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-20">
                            <div className="animate-on-scroll animate-fade-in-left">
                                <div className="flex items-center gap-4 mb-4">
                                    <span className="bg-red-600 text-white text-sm font-bold px-4 py-1 rounded-full">Popular</span>
                                    <span className="text-gray-500 text-sm font-medium">30 min tour</span>
                                </div>
                                <h1 className="text-5xl md:text-6xl font-extrabold text-red-900 leading-tight">Enchey Monastery</h1>
                                <div className="flex items-center text-gray-600 mt-4"><LocationPinIcon /> Gangtok</div>
                                <p className="mt-6 text-lg text-gray-700 leading-relaxed">A peaceful sanctuary offering panoramic views of Gangtok and the surrounding Himalayan peaks.</p>
                            ...
                            <div className="relative w-full h-80 lg:h-96 rounded-2xl shadow-2xl overflow-hidden animate-on-scroll animate-fade-in-right">
                                {!showStreetView ? (
                                    <>
                                        <img src="/enchy.jpg" alt="360 Preview of Enchey Monastery" className="w-full h-full object-cover" />
                                    ...
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!4v1757876171196!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJREc2cWJ1andF!2m2!1d27.33580288383717!2d88.61928037024981!3f83.0975468726877!4f-9.853918713732796!5f0.4000000000000002"
                                        width="100%"
                                        height="100%"
                                        style={{ border: 0 }}
                                        allowFullScreen
                        ...
                        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                            ...
                            <div className="lg:col-span-2 space-y-12">
                                <div className="animate-on-scroll animate-fade-in-up">
                                    <h2 className="text-3xl font-bold text-red-900 mb-6">About Enchey Monastery</h2>
                                    <div className="bg-[#fef8e7] border border-amber-300/50 rounded-2xl p-8 shadow-lg">
                                        ...
                                        <p className="text-gray-700 leading-relaxed mb-4">Enchey Monastery stands as one of Sikkim's most significant spiritual centers, embodying centuries of Buddhist tradition and cultural heritage. This sacred space has been a beacon of wisdom and peace, offering visitors a glimpse into the profound spiritual practices that have shaped the region.</p>
                            ...
                            <aside className="space-y-8 animate-on-scroll animate-fade-in-up" style={{ transitionDelay: '300ms' }}>
                                <div className="bg-[#fef8e7] border border-amber-300/50 rounded-2xl p-6 shadow-lg">
                                    ...
                                    <ul className="space-y-3 text-gray-700">
                                        <li className="flex items-center"><LocationPinIcon /> Gangtok</li>
                                        <li className="flex items-center"><ClockIcon /> 30 minute virtual tour</li>
                ...
                {/* --- Final CTA Section --- */}
                <div className="animated-gradient-bg py-20">
