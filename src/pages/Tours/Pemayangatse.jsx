...
export default function Pemayangtse() {
    ...
    // Pemayangtse image shows 4 features
    const tourFeatures = [
                        ...
                        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-20">
                            <div className="animate-on-scroll animate-fade-in-left">
                                <div className="flex items-center gap-4 mb-4">
                                    <span className="bg-orange-500 text-white text-sm font-bold px-4 py-1 rounded-full">Historical</span>
                                    <span className="text-gray-500 text-sm font-medium">60 min tour</span>
                                </div>
                                <h1 className="text-5xl md:text-6xl font-extrabold text-red-900 leading-tight">Pemayangtse Monastery</h1>
                                <div className="flex items-center text-gray-600 mt-4"><LocationPinIcon /> West Sikkim</div>
                                <p className="mt-6 text-lg text-gray-700 leading-relaxed">One of Sikkim's oldest monasteries, featuring exquisite murals and ancient Buddhist scriptures.</p>
                            ...
                            {/* Hero right side: preview / street view */}
                            <div className="relative w-full h-80 lg:h-96 rounded-2xl shadow-2xl overflow-hidden animate-on-scroll animate-fade-in-right">
                                {!showStreetView ? (
                                    ...
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!4v1757876626939!6m8!1m7!1sCAoSF0NJSE0wb2dLRUlDQWdJQ0U3SXFEeFFF!2m2!1d27.30426034149243!2d88.30153660084635!3f357.7677482019719!4f7.215387078995818!5f0.7820865974627469"
                                        width="100%"
                                        height="100%"
                                        style={{ border: 0 }}
                                        allowFullScreen
                            ...
                            <div className="lg:col-span-2 space-y-12">
                                <div className="animate-on-scroll animate-fade-in-up">
                                    ...
                                    <div className="bg-[#fef8e7] border border-amber-300/50 rounded-2xl p-8 shadow-lg">
                                        ...
                                        <p className="text-gray-700 leading-relaxed mb-4">Pemayangtse Monastery stands as one of Sikkim's most significant spiritual centers, embodying centuries of Buddhist tradition and cultural heritage. This sacred space has been a beacon of wisdom and peace, offering visitors a glimpse into the profound spiritual practices that have shaped the region.</p>
