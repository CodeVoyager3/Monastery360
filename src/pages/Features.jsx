...
// --- Icon Components (Updated with new color palette) ---
          ...
          <main className="space-y-20  md:space-y-24">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-12  items-center">
              ...
              <div className="animate-on-scroll animate-fade-in-left">
                <h2 className="text-3xl font-bold text-red-600 mb-4 flex items-center"><ToursIcon /> 360° Virtual Tours</h2>
                ...
                <ul className="space-y-3 mb-8 text-gray-700">
                  <li className="flex items-center"><CheckCircleIcon /><span>Ultra high-resolution 360° photography</span></li>
                  <li className="flex items-center"><CheckCircleIcon /><span>Interactive hotspots with cultural insights</span></li>
                  <li className="flex items-center"><CheckCircleIcon /><span>Compatible across all devices</span></li>
                </ul>
              </div>
            </section>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="animate-on-scroll animate-fade-in-right">
                <h2 className="text-3xl font-bold text-red-600 mb-4 flex items-center"><AiIcon /> AI-Powered Storytelling</h2>
                <p className="text-gray-600 mb-6 leading-relaxed">
                 ...
                 <ul className="space-y-3 text-gray-700">
                  <li className="flex items-center"><CheckCircleIcon /><span>Available in English, Hindi, Nepali, and Sikkimese</span></li>
                  <li className="flex items-center"><CheckCircleIcon /><span>Culturally sensitive context generation</span></li>
                  <li className="flex items-center"><CheckCircleIcon /><span>Personalized learning experiences</span></li>
                </ul>
              </div>
            </section>
